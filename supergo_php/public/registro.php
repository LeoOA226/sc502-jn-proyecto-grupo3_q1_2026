...
<nav class="navbar navbar-expand-lg navbar-light navbar-sg sticky-top">
    <div class="container-fluid">
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
            ...
            <a class="nav-pill nav-pill-soft text-decoration-none" href="index.php">Ver inicio</a>
        </div>
    </div>
</nav>
                    ...
                    <form action="procesar_registro.php" method="post" class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input class="form-control" type="text" name="nombre" maxlength="100" required>
                                <div class="invalid-feedback">Ingrese su nombre.</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Correo</label>
                                <input class="form-control" type="email" name="correo" maxlength="120" required>
                                <div class="invalid-feedback">Ingrese un correo válido.</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Contraseña</label>
                                <input class="form-control" type="password" name="contrasena" minlength="6" required>
